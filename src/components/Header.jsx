...
export default function Header({ inputTxt, setInputText, options, setOptions, setShowSection , settings , output}) {
  return (
    <div
      className={`font-outfit flex flex-col items-center w-full max-w-[500px] rounded-[8px] pl-1 py-2 ${settings.themeToggle === false ? 'bg-slate-800' : 'bg-zinc-700'} text-white`}
    >
